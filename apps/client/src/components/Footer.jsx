            ...
            <div className='flex flex-col gap-10 md:flex-row pt-6'>
                ...
                <div className='md:w-1/2'>
                    ...
                    <p className='mt-3 max-w-md text-sm leading-relaxed text-gray-300'>
                        Modern fashion, curated essentials, and timeless pieces
                ...
                <div className='grid flex-1 grid-cols-3 gap-8'>
                    ...
                    <div>
                        ...
                        <ul className='space-y-2 text-sm'>
                            <li>
                                <Link to='/contact' className='border-b border-transparent hover:border-white'>
                                    Contact
                                </Link>
                            </li>

                            <li>
                                <Link to='/account' className='border-b border-transparent hover:border-white'>
                                    Account
                                </Link>
                            </li>
                        </ul>
                    ...
                    <div>
                        ...
                        <ul className='space-y-2 text-sm'>
                            ...
                            {categories.map((cat, idx) => (
                                <li key={idx}>
                                    <Link to={cat.to} className='border-b border-transparent hover:border-white'>{cat.name}</Link>
                                </li>
                            ))}
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className='space-y-2 text-sm'>
                            <li>
                                <Link to='/privacy-policy' className='border-b border-transparent hover:border-white'>
                                    Privacy Policy
                                </Link>
                            </li>
                        </ul>
